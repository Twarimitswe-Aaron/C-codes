...
// Custom colors
extern COLORREF g_crBackground; // White background
extern COLORREF g_crText;         // Dark blue text
extern COLORREF g_crAccent;      // Standard blue accent
extern COLORREF g_crAccentDark;   // Darker accent for pressed state
extern COLORREF g_crAccentLight; // Lighter accent for hover state

// Global font handle for Dashboard title
extern HFONT hFontDashboardTitle;
